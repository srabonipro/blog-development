                ...
                <div class="col-md-12 col-lg-4 sidebar">
                    ...
                    <div class="sidebar-box">
                        <div class="bio text-center">
                            <img src="{{ $post->user->image }}" alt="Image Placeholder" class="img-fluid mb-5">
                            <div class="bio-body">
        ...
        <div class="container">
            ...
            <div class="row align-items-stretch retro-layout">
                ...
                <div class="col-md-5 order-md-2">
                    @foreach ($firstRelatedPosts as $post)
                    <a href="{{ route('frontend.post', $post->slug) }}" class="hentry img-1 h-100 gradient"
                ...
                <div class="col-md-7">
                    @foreach ($thirdRelatedPosts as $post)
                    <a href="{{ route('frontend.post', $post->slug) }}" class="hentry img-2 v-height mb30 gradient"
                        style="background-image: url('{{ $post->image }}');">
                    ...
                    <div class="two-col d-block d-md-flex justify-content-between">
                        @foreach ($secondRelatedPosts as $post)
                        <a href="{{ route('frontend.post', $post->slug) }}" class="hentry v-height img-2 gradient"
                            style="background-image: url('{{ $post->image }}');">
